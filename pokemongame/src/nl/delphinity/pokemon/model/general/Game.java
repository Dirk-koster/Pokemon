...
public class Game {
    ...
    static {
        ...
        GymLeader viridianLeader = new GymLeader("rens", new Badge("The Cascade Badge"), viridianCity);
        Pokemon x = new Pokemon(PokemonData.GYARADOS);
        x.setLevel(5);
        x.setOwner(viridianLeader);
        viridianLeader.setActivePokemon(x);
        viridianLeader.getPokemonCollection().add(x);
        viridianCity.setGymLeader(viridianLeader);
        
        GymLeader palletLeader = new GymLeader("marlon", new Badge("The Volcano Badge"), palletTown);
        Pokemon a = new Pokemon(PokemonData.ARCANINE);
        a.setLevel(5);
        a.setOwner(palletLeader);
        palletLeader.setActivePokemon(x);
        palletLeader.getPokemonCollection().add(x);
    ...
    private static void startGymBattle() {
    	Battle trainerBattle = trainer.challengeTrainer(Trainer.opponent = Game.trainer.getCurrentArea().getGymLeader());
    ...
    public static void deserialization() {
		try {
			FileInputStream fileIn = new FileInputStream(
					"C://Users//Gebruiker//Documents//savedTrainer.txt");
	...
	public static void serialization() {
		File file = new File("C://Users//Gebruiker//Documents//savedTrainer.txt");
		try {
			FileOutputStream fileOut = new FileOutputStream(file);
			ObjectOutputStream out = new ObjectOutputStream(fileOut);
			out.writeObject(trainer);
			System.out.println(
					"Geserialiseerde data is opgeslagen in C://Users//Gebruiker//Documents//savedTrainer.txt");
		} catch (IOException i) {
			i.printStackTrace();
		}
	}
